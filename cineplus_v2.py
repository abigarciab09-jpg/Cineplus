...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 1.1.1 on Fri Oct 31 22:43:09 2025
#
...
class Ventana4(wx.Frame):
    def __init__(self, parent, informacion="", subtotal1=0, informacion2="", subtotal2=0):
        ...
        self.SetBackgroundColour(wx.Colour(182, 219, 197))
        self.SetForegroundColour(wx.Colour(127, 163, 255))
        ...
        bitmap_1 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("./tickett.jpg", wx.BITMAP_TYPE_ANY))
        grid_sizer_2.Add(bitmap_1, 0, wx.ALIGN_CENTER, 0)

        label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, "   TICKET")
        label_1.SetMinSize((50, 20))
        label_1.SetFont(wx.Font(17, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Arial"))
        grid_sizer_2.Add(label_1, 0, wx.EXPAND, 0)

        bitmap_2 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("./tickett.jpg", wx.BITMAP_TYPE_ANY))
        grid_sizer_2.Add(bitmap_2, 0, wx.ALIGN_CENTER, 0)

        label_2 = wx.StaticText(self.panel_1, wx.ID_ANY, "TAQUILLA")
        label_2.SetFont(wx.Font(9, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        ...
        lbSubtotalTaquilla.SetFont(wx.Font(10, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_1.Add(lbSubtotalTaquilla, 0, 0, 0)

        label_5 = wx.StaticText(self.panel_1, wx.ID_ANY, "DULCERIA")
        label_5.SetMinSize((60, 20))
        label_5.SetFont(wx.Font(9, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        ...
        lbSubtotalDulceria.SetFont(wx.Font(10, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        ...
        lbTotal.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_1.Add(lbTotal, 0, wx.ALIGN_RIGHT, 0)
...
class Ventana1(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = kwds.get("style", 0) | wx.DEFAULT_FRAME_STYLE
        wx.Frame.__init__(self, *args, **kwds)
        self.SetSize((400, 471))
        self.SetTitle("Inicio de sesión - Cine Plus")
        _icon = wx.NullIcon
        _icon.CopyFromBitmap(wx.Bitmap("logo.jpg", wx.BITMAP_TYPE_ANY))
        self.SetIcon(_icon)

        self.panel_1 = wx.Panel(self, wx.ID_ANY)
        self.panel_1.SetBackgroundColour(wx.Colour(127, 227, 190))
        ...
        IbTitulo.SetForegroundColour(wx.Colour(171, 131, 191))
        ...
        lbLogo = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("logo.jpg", wx.BITMAP_TYPE_ANY))
        sizer_1.Add(lbLogo, 0, wx.EXPAND, 0)

        IbUsuario = wx.StaticText(self.panel_1, wx.ID_ANY, "Usuario:", style=wx.ALIGN_CENTER_HORIZONTAL)
        IbUsuario.SetMinSize((445, 20))
        IbUsuario.SetForegroundColour(wx.Colour(255, 132, 154))
        IbUsuario.SetFont(wx.Font(9, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        ...
        IbClave.SetForegroundColour(wx.Colour(231, 149, 163))
        IbClave.SetFont(wx.Font(9, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        ...
        self.tfClave.SetFont(wx.Font(9, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
...
class ventana2(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.panel_1 = wx.Panel(self, wx.ID_ANY)
        self.panel_1.SetBackgroundColour(wx.Colour(242, 96, 246))
        ...
        label_3.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        ...
        self.cmbPelicula = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=["10 cosas que odio de ti", "Cenicienta ", "Megan 2.0", "", "", "", ""], style=wx.CB_DROPDOWN)
        self.cmbPelicula.SetMinSize((120, 30))
        self.cmbPelicula.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Arial"))
        ...
        label_6.SetFont(wx.Font(16, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        ...
        self.tfAdultos.SetFont(wx.Font(9, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Arial"))
        grid_sizer_6.Add(self.tfAdultos, 0, 0, 0)

        label_8 = wx.StaticText(self.panel_1, wx.ID_ANY, "Menores ($70):")
        label_8.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        ...
        self.lbSubtotal.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
    ...
    def seleccionPelicula(self, event):  # wxGlade: ventana2.<event_handler>
        ...
        if pelicula == "10 cosas que odio de ti":
...
class Ventana3(wx.Frame):
    def __init__(self, parent, informacion="", subtotal=0):
        ...
        bitmap_1 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("./ddulces.jfif", wx.BITMAP_TYPE_ANY))
        grid_sizer_1.Add(bitmap_1, 0, wx.EXPAND, 0)

        label_1 = wx.StaticText(self.panel_1, wx.ID_ANY, "Dulceria:")
        label_1.SetForegroundColour(wx.Colour(226, 169, 240))
        label_1.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, 0, "Arial Rounded MT Bold"))
        grid_sizer_1.Add(label_1, 0, wx.ALIGN_CENTER, 0)

        bitmap_2 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("./ddulces.jfif", wx.BITMAP_TYPE_ANY))
        ...
        label_5 = wx.StaticText(self.panel_1, wx.ID_ANY, "Refresco ch")
        grid_sizer_4.Add(label_5, 0, wx.ALIGN_CENTER, 0)

        bitmap_7 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("./combo 1.jfif", wx.BITMAP_TYPE_ANY))
        grid_sizer_3.Add(bitmap_7, 0, 0, 0)
        ...
        grid_sizer_5.Add(self.spComboC, 0, wx.ALIGN_CENTER, 0)

        grid_sizer_6 = wx.GridSizer(3, 1, 0, 0)
        grid_sizer_5.Add(grid_sizer_6, 1, wx.EXPAND, 0)

        label_6 = wx.StaticText(self.panel_1, wx.ID_ANY, "Cuates $130")
        label_6.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, ""))
        grid_sizer_6.Add(label_6, 0, 0, 0)

        label_7 = wx.StaticText(self.panel_1, wx.ID_ANY, "Palomitas md")
        grid_sizer_6.Add(label_7, 0, 0, 0)

        label_8 = wx.StaticText(self.panel_1, wx.ID_ANY, "2 Refrescos md")
        grid_sizer_6.Add(label_8, 0, 0, 0)

        grid_sizer_9 = wx.FlexGridSizer(1, 2, 0, 0)
        grid_sizer_5.Add(grid_sizer_9, 1, wx.EXPAND, 0)

        bitmap_8 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("./combo 1.jfif", wx.BITMAP_TYPE_ANY))
        grid_sizer_9.Add(bitmap_8, 0, 0, 0)

        bitmap_11 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("C:/Users/PC/Downloads/refrescos  solo.jpg", wx.BITMAP_TYPE_ANY))
        grid_sizer_9.Add(bitmap_11, 0, 0, 0)
        ...
        label_11 = wx.StaticText(self.panel_1, wx.ID_ANY, "Familiar")
        ...
        label_12 = wx.StaticText(self.panel_1, wx.ID_ANY, "Palomitas G")
        grid_sizer_12.Add(label_12, 0, 0, 0)

        label_13 = wx.StaticText(self.panel_1, wx.ID_ANY, "3 Refrescos G")
        grid_sizer_12.Add(label_13, 0, 0, 0)

        label_14 = wx.StaticText(self.panel_1, wx.ID_ANY, "1 Dulce")
        grid_sizer_12.Add(label_14, 0, 0, 0)

        grid_sizer_13 = wx.FlexGridSizer(1, 4, 0, 0)
        grid_sizer_8.Add(grid_sizer_13, 1, wx.EXPAND, 0)

        bitmap_9 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("./combo 1.jfif", wx.BITMAP_TYPE_ANY))
        grid_sizer_13.Add(bitmap_9, 0, 0, 0)

        bitmap_3 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("C:/Users/PC/Downloads/refrescos  solo.jpg", wx.BITMAP_TYPE_ANY))
        bitmap_3.SetMinSize((61, 113))
        grid_sizer_13.Add(bitmap_3, 0, 0, 0)

        bitmap_6 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("C:/Users/PC/Downloads/refrescos  solo.jpg", wx.BITMAP_TYPE_ANY))
        grid_sizer_13.Add(bitmap_6, 0, 0, 0)

        bitmap_10 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("C:/Users/PC/Downloads/dulce.jpeg", wx.BITMAP_TYPE_ANY))
        grid_sizer_13.Add(bitmap_10, 0, 0, 0)

        grid_sizer_7.Add((0, 0), 0, 0, 0)

        grid_sizer_14 = wx.GridSizer(1, 2, 0, 0)
        sizer_1.Add(grid_sizer_14, 1, wx.EXPAND, 0)

        grid_sizer_15 = wx.FlexGridSizer(1, 2, 0, 0)
        grid_sizer_14.Add(grid_sizer_15, 1, wx.EXPAND, 0)

        bitmap_12 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("E:/pop.jpeg", wx.BITMAP_TYPE_ANY))
        grid_sizer_15.Add(bitmap_12, 0, 0, 0)

        grid_sizer_16 = wx.GridSizer(4, 1, 0, 0)
        grid_sizer_15.Add(grid_sizer_16, 1, wx.EXPAND, 0)

        label_15 = wx.StaticText(self.panel_1, wx.ID_ANY, "Palomitas")
        label_15.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_16.Add(label_15, 0, 0, 0)

        grid_sizer_17 = wx.GridSizer(1, 2, 0, 0)
        grid_sizer_16.Add(grid_sizer_17, 1, wx.EXPAND, 0)

        self.spPalomitaCh = wx.SpinCtrl(self.panel_1, wx.ID_ANY, "0", min=0, max=100)
        grid_sizer_17.Add(self.spPalomitaCh, 0, 0, 0)

        label_16 = wx.StaticText(self.panel_1, wx.ID_ANY, "Chicas")
        label_16.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_17.Add(label_16, 0, 0, 0)
        ...
        label_17 = wx.StaticText(self.panel_1, wx.ID_ANY, "Medianas")
        label_17.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        ...
        label_18 = wx.StaticText(self.panel_1, wx.ID_ANY, "Grandes")
        label_18.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_19.Add(label_18, 0, 0, 0)

        grid_sizer_20 = wx.FlexGridSizer(1, 2, 0, 0)
        grid_sizer_14.Add(grid_sizer_20, 1, wx.EXPAND, 0)

        bitmap_13 = wx.StaticBitmap(self.panel_1, wx.ID_ANY, wx.Bitmap("C:/Users/PC/Downloads/refrescos  solo.jpg", wx.BITMAP_TYPE_ANY))
        grid_sizer_20.Add(bitmap_13, 0, 0, 0)

        grid_sizer_21 = wx.GridSizer(3, 1, 0, 0)
        grid_sizer_20.Add(grid_sizer_21, 1, wx.EXPAND, 0)

        label_19 = wx.StaticText(self.panel_1, wx.ID_ANY, "Refresco")
        label_19.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_21.Add(label_19, 0, 0, 0)

        grid_sizer_22 = wx.GridSizer(1, 3, 0, 0)
        grid_sizer_21.Add(grid_sizer_22, 1, wx.EXPAND, 0)

        label_20 = wx.StaticText(self.panel_1, wx.ID_ANY, u"Tamaño")
        ...
        label_21 = wx.StaticText(self.panel_1, wx.ID_ANY, "Sabor")
        label_21.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_22.Add(label_21, 0, 0, 0)

        label_22 = wx.StaticText(self.panel_1, wx.ID_ANY, "Cantidad")
        label_22.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_22.Add(label_22, 0, 0, 0)

        grid_sizer_23 = wx.GridSizer(1, 4, 0, 0)
        grid_sizer_21.Add(grid_sizer_23, 1, wx.EXPAND, 0)

        self.cmbTamano = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=["CHICO", "MEDIANO", "GRANDE", "", "", "", "", ""], style=wx.CB_DROPDOWN)
        grid_sizer_23.Add(self.cmbTamano, 0, wx.ALIGN_CENTER, 0)

        self.cmbSabor = wx.ComboBox(self.panel_1, wx.ID_ANY, choices=["MANZANITA", "COCA", "FANTA", ""], style=wx.CB_DROPDOWN)
        grid_sizer_23.Add(self.cmbSabor, 0, wx.ALIGN_CENTER, 0)

        self.spCantidad = wx.SpinCtrl(self.panel_1, wx.ID_ANY, "0", min=0, max=100)
        grid_sizer_23.Add(self.spCantidad, 0, wx.EXPAND, 0)

        self.btnAgregar = wx.Button(self.panel_1, wx.ID_ANY, "Agregar")
        grid_sizer_23.Add(self.btnAgregar, 0, 0, 0)

        grid_sizer_24 = wx.GridSizer(1, 2, 0, 0)
        sizer_1.Add(grid_sizer_24, 1, wx.EXPAND, 0)

        grid_sizer_25 = wx.FlexGridSizer(1, 2, 0, 0)
        grid_sizer_24.Add(grid_sizer_25, 1, wx.EXPAND, 0)

        self.lbProductosAgregados = wx.StaticText(self.panel_1, wx.ID_ANY, "Productos agregados:")
        self.lbProductosAgregados.SetFont(wx.Font(14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_25.Add(self.lbProductosAgregados, 0, 0, 0)

        label_24 = wx.StaticText(self.panel_1, wx.ID_ANY, "......")
        grid_sizer_25.Add(label_24, 0, wx.ALIGN_CENTER, 0)

        grid_sizer_26 = wx.GridSizer(1, 2, 0, 0)
        grid_sizer_24.Add(grid_sizer_26, 1, wx.EXPAND, 0)

        label_25 = wx.StaticText(self.panel_1, wx.ID_ANY, "Subtotal Dulceria:")
        label_25.SetFont(wx.Font(12, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_BOLD, 0, "Segoe UI"))
        grid_sizer_26.Add(label_25, 0, 0, 0)
        ...
        grid_sizer_26.Add(self.lbSubtotal, 0, wx.EXPAND, 0)

        grid_sizer_27 = wx.GridSizer(1, 2, 0, 0)
        sizer_1.Add(grid_sizer_27, 1, wx.EXPAND, 0)

        self.btnLimpiar = wx.Button(self.panel_1, wx.ID_ANY, "Limpiar")
        self.btnLimpiar.SetMinSize((85, 23))
        grid_sizer_27.Add(self.btnLimpiar, 0, wx.ALIGN_CENTER, 0)

        self.btnSiguiente = wx.Button(self.panel_1, wx.ID_ANY, "Siguiente")
        self.btnSiguiente.SetMinSize((95, 23))
        grid_sizer_27.Add(self.btnSiguiente, 0, wx.ALIGN_CENTER, 0)
        ...
        self.spPalomitaCh.Bind(wx.EVT_SPINCTRL, self.calcularPalomitasCh)
    ...
    def calcularPalomitasCh(self, event):  # wxGlade: Ventana3.<event_handler>
        numero=int(self.spPalomitaCh.GetValue())
        subtotalpalomitas=numero*30
